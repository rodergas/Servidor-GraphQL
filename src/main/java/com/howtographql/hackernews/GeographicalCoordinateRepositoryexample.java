...
public class GeographicalCoordinateRepositoryexample {
  private final ArrayList<GeographicalCoordinate> GeographicalCoordinates;

  public GeographicalCoordinateRepositoryexample() {
  ...
  public ArrayList<GeographicalCoordinate> getAllGeographicalCoordinates() {
