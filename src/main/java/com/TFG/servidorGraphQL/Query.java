...
public class Query implements GraphQLQueryResolver {
  ...
  public List<SuburbDistrict> allSuburbDistrict(){
	  List<SuburbDistrict> a = new ArrayList<>();
	  a.addAll(DistrictRepositoryInstance.getAllDistricts());
	  a.addAll(SuburbRepositoryInstance.getAllSuburbs());
	  return a;
